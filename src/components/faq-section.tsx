...
export function FaqSection() {
  return (
    <section id="faq" className="scroll-mt-20 bg-bg-subtle py-[var(--spacing-section-sm)] md:py-[var(--spacing-section-md)]">
      <Container className="grid gap-12 lg:grid-cols-[minmax(0,20rem)_minmax(0,1fr)]">
        <SectionHeading eyebrow="FAQ" title="Everything you need to know before you book a call" />
